...
public class Filter implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(getProperty(), other.getProperty()) && Objects.equals(getOperator(), other.getOperator()) && Objects.equals(getValue(), other.getValue());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getProperty(), getOperator(), getValue());
    }
}