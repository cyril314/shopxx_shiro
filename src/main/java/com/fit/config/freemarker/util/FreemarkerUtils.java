package com.fit.config.freemarker.util;
...
import com.fit.config.freemarker.CommonAttributes;
import com.fit.config.freemarker.EnumConverter;
...
public final class FreemarkerUtils {
    ...
    public static String processFtl(String templateFileName, Map<String, ?> model) throws IOException, TemplateException {
