...
[#if totalPages > 1]
    <div class="pagination">
        ...
        [/#if]
        <span class="pageSkip">
			${message("shop.page.totalPages", totalPages)} ${message("shop.page.pageNumber", '<input id="pageNumber" name="pageNumber" value="' + pageNumber + '" maxlength="9" onpaste="return false;" />')}
