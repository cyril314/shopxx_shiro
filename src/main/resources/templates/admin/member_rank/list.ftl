...
<head>
    ...
    <title>${message("shop.memberRank.list")} - Powered By SHOP++</title>
...
<body>
<div class="path">
    <a href="${base!}/admin/common/index">${message("shop.path.index")}</a> &raquo; ${message("shop.memberRank.list")}
...
<form id="listForm" action="list" method="get">
                ...
                <ul id="searchPropertyOption">
                    <li>
                        <a href="javascript:;"[#if page.searchProperty == "name"] class="current"[/#if]
                           val="name">${message("MemberRank.name")}</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <table id="listTable" class="list">
        <tr>
            ...
            <th><a href="javascript:;" class="sort" name="name">${message("MemberRank.name")}</a></th>
            <th><a href="javascript:;" class="sort" name="isDefault">${message("MemberRank.isDefault")}</a></th>
        ...
        <tr>
            <td>
                <input type="checkbox" name="ids"
                       [#if memberRank.isDefault] title="${message("shop.memberRank.deleteDefaultNotAllowed")}" disabled="disabled"[#else] value="${memberRank.id}"[/#if] />
            </td>
            <td>${memberRank.name}</td>
            <td>${message(memberRank.isDefault?string('admin.common.true', 'admin.common.false'))}</td>
            <td><a href="edit?id=${memberRank.id}">[${message("shop.common.edit")}]</a></td>
        </tr>
    </
    #list>
    </table>
