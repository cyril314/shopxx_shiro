...
<title>${message("shop.exam.add")} - Powered By SHOP++</title>
	...
	<form id="inputForm" action="save" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" id="startDate" name="startDate" class="text Wdate" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss', maxDate: '#F{$dp.$D(\'endDate\')}'});" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="endDate" name="endDate" class="text Wdate" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss', minDate: '#F{$dp.$D(\'startDate\')}'});" />
				</td>
			</tr>
